...
namespace ArborEditor
{
	...
	internal sealed class AnimatorParameterReferencePropertyDrawer : PropertyDrawer
	{
		Rect DoGUI(Rect position, SerializedProperty property, GUIContent label, bool isDraw)
		{
			...
			if (isDraw)
			{
				AnimatorGUITools.AnimatorParameterField(lineRect, animatorController, referenceProperty.nameProperty, referenceProperty.typeProperty, EditorGUITools.GetTextContent("Parameter"), hasType, parameterType);
			}
