...
namespace ArborEditor
{
	internal sealed class VariableGeneratorWindow : EditorWindow
	{
		...
		{
			titleContent = EditorGUITools.GetTextContent("Variable Generator");
		}

		private void OnGUI()
		{
			EditorGUI.BeginChangeCheck();
			_VariableName = EditorGUILayout.TextField(EditorGUITools.GetTextContent("Variable Name"), _VariableName);
