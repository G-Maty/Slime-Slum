...
namespace ArborEditor.UIElements
{
	...
	internal sealed class RectangleSelector : DragManipulator
	{
		...
		void OnChangeGraphView(IChangeGraphViewEvent e)
		{
			...
			Vector2 localMousePosition = graphView.GraphToElement(target, graphView.mousePosition);
		...
		protected override void OnMouseDown(MouseDownEvent e)
		{
			...
			_GraphView.graphEditor.BeginSelection(!_ActionKey && !_ShiftKey);
		...
		bool UpdateSelection(Vector2 mousePosition, bool actionKey, bool shiftKey)
		{
			...
			_GraphView.graphEditor.SelectNodesInRect(selectionRect, actionKey, shiftKey);

			selectionRect = _GraphView.GraphToElement(_RectangleElement.parent, selectionRect);
			_RectangleElement.SetLayout(selectionRect);

			_GraphView.window.DoRepaint();
		...
		{
			_GraphView.graphEditor.EndSelection();
		}
		...
		protected override void OnMouseCaptureOut(MouseCaptureOutEvent e)
		{
			...
			_GraphView.graphEditor.CancelSelection();
		}
