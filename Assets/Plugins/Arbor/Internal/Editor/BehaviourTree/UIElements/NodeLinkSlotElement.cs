				...
				if (graphEditor != null && _Dragging)
				{
					...
					else
					{
						...
						menu.AddItem(EditorContents.createComposite, false, () =>
						{
							...
							CompositeBehaviourMenuWindow.instance.Init(graphEditor, graphPoint, buttonRect, OnSelectComposite, null, OnCancelSelectType);
						});
						...
						if (!slotElement._IsParentSlot)
						{
							menu.AddItem(EditorContents.createAction, false, () =>
							{
								...
								ActionBehaviourMenuWindow.instance.Init(graphEditor, graphPoint, buttonRect, OnSelectAction, null, OnCancelSelectType);
							});
						}
