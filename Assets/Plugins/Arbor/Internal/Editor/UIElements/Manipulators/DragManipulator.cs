	...
	internal abstract class DragManipulator : MouseManipulator
	{
		...
		public bool isActive
		{
			...
			private set
			{
				...
				{
					_IsActive = value;
					if (onChangedActive != null)
					{
						onChangedActive(_IsActive);
					}
				}
			}
		}
		...
		public void StartDrag()
		{
			...
			if (_GraphView != null)
			{
				target.UnregisterCallback<MouseMoveEvent>(_GraphView.OnMouseMove);
			...
			while (element != null)
			{
				_GraphView = element as GraphView;
				if (_GraphView != null)
				{
					break;
				}
			...
			if (_GraphView != null)
			{
				target.RegisterCallback<MouseMoveEvent>(_GraphView.OnMouseMove);
