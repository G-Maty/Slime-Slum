...
namespace ArborEditor.UIElements
{
	...
	internal sealed class ArrowCapElement : VisualElement
	{
		...
		public override bool ContainsPoint(Vector2 localPoint)
		{
			...
			Vector3 cross = Vector3.Cross(_Direction, Vector3.forward).normalized;

			Vector3 position = parent.ChangeCoordinatesTo(this, _Position);
			Vector3 p1 = position + _Direction * _Width;
			Vector3 p2 = position - cross * _Width * 0.5f;
			Vector3 p3 = position + cross * _Width * 0.5f;
